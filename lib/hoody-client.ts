...
import { getKitCatalogEntries, type KitCatalogEntry, type KitCatalogOptions } from './kit-catalog.js';
...
export class HoodyClient extends GeneratedHoodyClient {
  ...
  static override async authenticate(
    baseURL: string,
