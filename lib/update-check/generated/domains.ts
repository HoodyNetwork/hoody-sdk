...
// Bound to package.json version 1.0.0-beta.4.
// Trust map: 1 domain(s) — hoody.com.
// Version floor: 1.0.0-beta.4 (rejects channel.json latest < floor).
...
export const HOODY_VERSION = "1.0.0-beta.4";
...
export const HOODY_VERSION_FLOOR = "1.0.0-beta.4";
