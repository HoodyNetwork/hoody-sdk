...
export class SettingsServiceBase {
     ...
     */
    async listFusion(options, _templateVars) {
    ...
    async *listFusionIterator(...args) {
        ...
        while (hasNext && pageCount < maxPages) {
            ...
            const response = await this.listFusion(...requestArgs);
     ...
     */
    async deleteFusion(slug, options, _templateVars) {
        const { realm, XHoodyCwd, XHoodyConfigDir, XHoodyContainer, XHoodyRealm, signal, timeoutMs, retries, retryDelayMs, retryOnStatuses, middlewareContext, authRetry, rawResponse, responseType } = options || {};
        // Validate required parameter: slug
        if (slug === undefined || slug === null) {
            throw new ValidationError('slug is required', 'slug');
