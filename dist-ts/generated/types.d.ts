        ...
        permissions?: {
            ...
            financial?: {
                ...
                server_rental?: {
                    ...
                    rent_servers?: boolean;
                    extend_rentals?: boolean;
                    terminate_rentals?: boolean;
                };
            };
            resources?: {
                vault?: boolean;
                events?: boolean;
                ssh_keys?: boolean;
                storage_shares?: boolean;
                proxy_aliases?: boolean;
                firewalls?: boolean;
                realms?: boolean;
                auth_token_public_profile?: boolean;
...
export interface ApiAuthTokensCreateRequest {
    ...
    expires_at?: string | "today" | "tomorrow" | number;
    /**
...
export interface ApiAuthTokensCopyRequest {
    ...
    expires_at?: string | "today" | "tomorrow" | number | null;
    /**
     * TOTP code (6 digits) or backup code (10 alphanumeric). Required if 2FA is enabled on the account and authenticating via JWT.
     * @maxLength 12
     */
...
export interface ApiAuthTokensGetCurrentResponse {
    ...
    data: {
        ...
        restrictions: {
            has_realm_restrictions: boolean;
            requires_realm_scope: boolean;
            allowed_realm_ids: string[];
            allow_no_realm: boolean;
            active_realm_id: null | string;
        };
    };
}
...
export interface ApiAuthenticationGetCurrentUserResponse {
    ...
    data: {
        ...
        pending_pool_invitations?: number;
    };
}
...
export interface RedeemInviteCodeResponse {
    ...
    data: {
        unlocked?: boolean;
        required?: boolean;
        claim_blocked_reason?: "none" | "pool_empty";
        server?: Record<string, unknown> | null;
        project?: Record<string, unknown> | null;
        container?: Record<string, unknown> | null;
    };
...
export interface GetFreeTierStatusResponse {
    ...
    data: {
        ...
        unlocked?: boolean;
        has_free_server?: boolean;
        can_claim?: boolean;
        claim_blocked_reason?: "none" | "invite_required" | "pool_empty" | "already_claimed";
        signup_code_failed?: boolean;
    };
}
...
export interface ApiContainersListByProjectResponse {
    ...
    data: {
        containers?: ({
            ...
            last_used_snapshot?: null | string;
            runtime_info?: {
                displays?: ({
                    display?: number;
                    pid?: number;
                    ...
                    latency?: null | Record<string, unknown> | number;
                    windows?: {
                        id: number;
                        title?: string;
                        pid?: number;
                ...
                services?: ({
                    ...
                    since?: string;
                    memory?: null | string;
                    cpu_usage?: null | string;
                    tasks?: null | number;
                    restart_count?: null | number;
                    last_restart?: null | string;
                    enabled?: null | boolean;
                    vendor_preset?: null | string;
                    main_pid?: null | number;
                    control_group?: null | string;
                    drop_in?: null | string;
                    loaded?: null | string;
                    docs?: null | string;
                    fragment_path?: null | string;
                })[];
                network_services?: {
                    protocol?: string;
                    port?: number;
            ...
            has_proxy_permissions?: boolean;
            proxy_permissions_scope?: "none" | "container" | "project" | "both";
            has_proxy_domains?: boolean;
            proxy_domains_count?: number;
            proxy_permissions?: {
                project?: string;
                container?: string;
...
export interface ApiContainersListResponse {
    ...
    data: {
        containers?: ({
            ...
            ssh_public_key?: null | string;
            comment?: null | string;
            source_container_id?: null | string;
            server_expired?: boolean;
            server_expired_at?: null | string;
            server_expired_reason?: null | string;
            created_at?: string;
            updated_at?: string;
            realm_ids?: string[];
            snapshot_count?: number;
...
export interface ApiContainersCopyResponse {
    ...
    data: {
        ...
        prespawn?: boolean;
        is_default?: boolean;
        container_image_id?: null | string;
        environment_vars?: Record<string, unknown>;
        volumes?: Record<string, unknown>;
        ssh_public_key?: null | string;
        comment?: null | string;
...
export interface ApiNotificationsListPublicResponse {
    ...
    data: ({
        ...
        title?: string;
        message?: string;
        type?: "MAINTENANCE" | "ANNOUNCEMENT" | "STATUS_UPDATE";
 ...
 */
export type ApiProxyPermissionsProjectSetTokenGroupRequest = {
    header: string;
    value: string;
} | {
    cookie: string;
 ...
 * Token authentication configuration. Exactly one location (header, cookie, or param) must be specified.
 */
export type ApiProxyPermissionsContainerSetTokenGroupRequest = {
    header: string;
    value: string;
} | {
    cookie: string;
...
export interface GetContainerProxyServiceResponse {
    ...
    data: {
        service?: string;
        is_reject_listed?: boolean;
        permissions_raw?: Record<string, unknown>;
        hooks?: Record<string, unknown>[];
        effective_default?: "allow" | "deny";
        file_version?: number;
        etag?: string;
    };
}
...
export interface ApiStorageSharesListResponse {
    ...
    data: ({
        ...
        source_container_id: string;
        source_path: string;
        target_container_id?: null | string;
        target_project_id?: null | string;
...
export interface ApiMetaGetPublicKeyResponse {
    ...
    data: {
        ...
        signing_format: {
            ...
            response_signed_data?: string;
            identity_claim_signed_data?: string;
            container_claim_signed_data?: string;
...
export interface ApiWalletGetAggregateBalancesResponse {
    ...
    data: {
        ...
        ai_usage?: string;
        ai_remaining?: string;
        ai_usage_status?: "live" | "unavailable";
    };
}
...
export interface ApiWalletTransferToAiResponse {
    ...
    message: string;
    data: {
        gross_transferred?: string;
        net_ai_credit?: string;
        fee?: string;
        general_balance?: string;
        ai_balance?: string;
        key_created?: boolean;
        limit_sync_pending?: boolean;
        replayed?: boolean;
    };
}
...
export interface CreateStripeCheckoutResponse {
    ...
    data: {
        intent?: {
            id: string;
            provider?: string;
            status?: "creating" | "pending" | "processing" | "completed" | "failed" | "expired" | "cancelled" | "admin_review";
            amount?: number;
            currency?: string;
            redirect_url?: null | string;
            credited_at?: null | string;
            expires_at?: null | string;
            created_at?: string;
            updated_at?: string;
        };
...
export interface ApiServerRentalBrowseResponse {
    ...
    data: ({
        ...
        model?: string;
        is_vm?: boolean;
        category?: null | "compute" | "memory" | "storage" | "general" | "gpu";
        featured?: boolean;
        ...
        specs?: {
            cpu?: {
                ...
                threads?: number | null;
                score?: number | null;
                score_type?: "passmark" | "geekbench_single" | "geekbench_multi" | null;
            } | null;
            ram?: {
                capacity_gb?: number;
                type?: "DDR3" | "DDR4" | "DDR5" | "ECC DDR4" | "ECC DDR5" | null;
        ...
        server?: null | {
            ...
            specs?: {
                cpu?: null | {
                    ...
                    threads?: null | number;
                    score?: null | number;
                    score_type?: null | "passmark" | "geekbench_single" | "geekbench_multi";
                };
                ram?: null | {
                    capacity_gb?: number;
                    type?: null | "DDR3" | "DDR4" | "DDR5" | "ECC DDR4" | "ECC DDR5";
                    speed_mhz?: null | number;
                };
                disks?: null | {
                    config?: ({
                        count?: number;
                ...
                network?: null | {
                    ...
                    bandwidth_formatted?: null | string;
...
export interface ApiServerCommandsListResponse {
    ...
    data: {
        commands?: ({
            ...
            example_parameters?: Record<string, unknown> | null;
...
export interface CurlSchedulesListResponse {
    ...
    data: {
        ...
        schedules: ({
            ...
            lastFireStatus?: "ok" | "error" | "timeout" | "disabled" | "load_error" | "incompatible" | "skipped_overload" | null;
            lastFireRunId?: string | null;
        })[];
    };
}
...
export interface ScheduleHistoryResponse {
    ...
    data: {
        ...
        entries: ({
            ...
            expression: string;
            runId: string;
            status: "ok" | "error" | "timeout" | "disabled" | "load_error" | "incompatible" | "skipped_overload";
            durationMs: number;
...
export interface FilesJournalQueryResponse {
    ...
    data: {
        ...
        entries: ({
            ...
            before?: string | null;
            blob?: boolean | null;
            blob_after?: boolean | null;
            blob_before?: boolean | null;
            dest?: string | null;
            hash?: string | null;
            id: number;
            ...
            op: "create" | "write" | "append" | "delete" | "touch" | "moved_from" | "moved_to" | "copied_from" | "copied_to" | "dir_moved_from" | "dir_moved_to" | "dir_copied_from" | "dir_copied_to" | "dir_deleted" | "mkdir" | "chmod" | "chown" | "gap";
            path: string;
            reason?: string | null;
            seq?: number | null;
            size?: number | null;
...
export interface FilesJournalGetStatsResponse {
    ...
    message: string;
    data: {
        entries_skipped_total: number;
        newest_entry_ts?: number | null;
        parse_failures: number;
        pruned_before_date?: string | null;
...
export interface FilesMountsCreateRequest {
    ...
    vfs_config?: {
        cache_max_age?: number | string;
        cache_max_size?: number | string;
        cache_mode?: "off" | "minimal" | "writes" | "full";
        dir_cache_time?: number | string;
    };
}
...
export type NotesAppendDocumentRequest = {
    text: string;
    type?: "paragraph" | "heading1" | "heading2" | "heading3" | "codeBlock";
    attrs?: Record<string, unknown> | null;
} | {
    blocks: ({
        type?: "paragraph" | "heading1" | "heading2" | "heading3" | "codeBlock" | "horizontalRule";
        content?: ({
            type: "text";
            text: string;
            marks?: ({
...
export interface NotesCommentsListResponse {
    ...
    data: {
        comments: ({
            ...
            anchorType: "document" | "block" | "text-range";
...
export interface Program {
    ...
    webhooks?: {
        enabled: boolean;
        urls: string[];
        events?: "*" | "all" | "ALL" | "STARTING" | "RUNNING" | "BACKOFF" | "STOPPING" | "STOPPED" | "EXITED" | "FATAL" | string[];
        headers?: Record<string, unknown>;
        timeout?: number;
        retry?: number;
    } | null;
