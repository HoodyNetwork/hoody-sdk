...
export class StreamsServiceBase {
     ...
     *
     */
    async listEvents(id, options, _templateVars) {
    ...
    async *listEventsIterator(...args) {
        ...
        while (hasNext && pageCount < maxPages) {
            ...
            const response = await this.listEvents(...requestArgs);
     ...
     *
     */
    async streamSse(id, options, _templateVars) {
     ...
     *
     */
    async streamWs(id, options, _templateVars) {
        const { since_id, since_timestamp, signal, timeoutMs, retries, retryDelayMs, retryOnStatuses, middlewareContext, authRetry, rawResponse, responseType } = options || {};
        // Validate required parameter: id
        if (id === undefined || id === null) {
            throw new ValidationError('id is required', 'id');
