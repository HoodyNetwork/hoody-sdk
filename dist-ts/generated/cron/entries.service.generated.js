...
export class EntriesServiceBase {
     ...
     *
     */
    async list(user, options, _templateVars) {
     ...
     *
     */
    async create(user, data, _templateVars, requestOptions) {
        // Validate required parameter: user
        if (user === undefined || user === null) {
            throw new ValidationError('user is required', 'user');
        }
     ...
     *
     */
    async get(user, id, _templateVars, requestOptions) {
        // Validate required parameter: user
        if (user === undefined || user === null) {
            throw new ValidationError('user is required', 'user');
        }
     ...
     *
     */
    async update(user, id, data, _templateVars, requestOptions) {
        // Validate required parameter: user
        if (user === undefined || user === null) {
            throw new ValidationError('user is required', 'user');
        }
     ...
     *
     */
    async delete(user, id, _templateVars, requestOptions) {
        // Validate required parameter: user
        if (user === undefined || user === null) {
            throw new ValidationError('user is required', 'user');
        }
