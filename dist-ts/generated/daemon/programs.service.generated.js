...
export class ProgramsServiceBase {
     ...
     */
    async reset(_templateVars, requestOptions) {
        // Build URL with template variables (from constructor's defaultUrlTemplateVariables or method-level _templateVars)
  ...
  **Wrong examples:** `apache2`, `nginx`, `postgresql`, `mysql` — use `systemctl` for these.
     */
    async add(data, _templateVars, requestOptions) {
     ...
     */
    async edit(id, data, _templateVars, requestOptions) {
        // Validate required parameter: id
        if (id === undefined || id === null) {
            throw new ValidationError('id is required', 'id');
        }
     ...
     */
    async remove(id, _templateVars, requestOptions) {
        // Validate required parameter: id
        if (id === undefined || id === null) {
            throw new ValidationError('id is required', 'id');
        }
