...
export class AppExecutionServiceBase {
  ...
  The returned set_id can be used with subsequent run requests to ensure race-free candidate selection.
     */
    async searchCandidates(options, _templateVars) {
     ...
     */
    async searchCandidatesPaged(data, _templateVars, requestOptions) {
     ...
     */
    async *searchCandidatesPagedIterator(...args) {
        ...
        while (hasNext && pageCount < maxPages) {
            ...
            const response = await this.searchCandidatesPaged(...requestArgs);
     ...
     */
    async runBatch(data, _templateVars, requestOptions) {
        // Validate required parameter: data
        if (data === undefined || data === null) {
            throw new ValidationError('data is required', 'data');
        }
