...
import type { ApiResponse, RunListSourcesResponse, RunCreateSourceRequest, RunCreateSourceResponse, RunUpdateSourceRequest, RunUpdateSourceResponse, RunSyncSourceResponse, RunSyncAllSourcesResponse, RunGetSourceDiagnosticsResponse } from '../types.js';
export declare abstract class SourcesServiceBase {
    ...
    }): Promise<RunListSourcesResponse>;
    /**
     ...
     */
    createSource(data: RunCreateSourceRequest, _templateVars?: {
        projectId?: string;
        containerId?: string;
        serviceIndex?: string | number;
        server?: string;
    ...
    updateSource(source_id: string, data: RunUpdateSourceRequest, _templateVars?: {
        ...
        rawResponse?: boolean;
        responseType?: 'auto' | 'json' | 'text' | 'arrayBuffer' | 'blob';
    }): Promise<RunUpdateSourceResponse>;
    /**
     * Delete a package source
     *
     * Remove a package source by its ID. Returns 204 on success.
     */
    deleteSource(source_id: string, _templateVars?: {
        projectId?: string;
        containerId?: string;
        serviceIndex?: string | number;
        server?: string;
     ...
     */
    syncSource(source_id: string, _templateVars?: {
        projectId?: string;
        containerId?: string;
        serviceIndex?: string | number;
        server?: string;
  ...
  Use GET /api/v1/run/jobs/{job_id}?wait=done&timeout_ms=30000 to poll for completion.
    ...
    syncAllSources(_templateVars?: {
        ...
        rawResponse?: boolean;
        responseType?: 'auto' | 'json' | 'text' | 'arrayBuffer' | 'blob';
    }): Promise<RunSyncAllSourcesResponse>;
    /**
     ...
     */
    getSourceDiagnostics(source_id: string, _templateVars?: {
        projectId?: string;
        containerId?: string;
        serviceIndex?: string | number;
        server?: string;
        ...
        rawResponse?: boolean;
        responseType?: 'auto' | 'json' | 'text' | 'arrayBuffer' | 'blob';
    }): Promise<RunGetSourceDiagnosticsResponse>;
}
