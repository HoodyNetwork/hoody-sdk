...
export class CollaboratorsServiceBase {
     ...
     */
    async update(notebookId, nodeId, collaboratorId, data, _templateVars, requestOptions) {
        // Validate required parameter: notebookId
        if (notebookId === undefined || notebookId === null) {
            throw new ValidationError('notebookId is required', 'notebookId');
        }
     ...
     */
    async remove(notebookId, nodeId, collaboratorId, _templateVars, requestOptions) {
        // Validate required parameter: notebookId
        if (notebookId === undefined || notebookId === null) {
            throw new ValidationError('notebookId is required', 'notebookId');
        }
