...
export class InteractionsServiceBase {
     ...
     */
    async markSeen(notebookId, nodeId, data, _templateVars, requestOptions) {
     ...
     */
    async markOpened(notebookId, nodeId, data, _templateVars, requestOptions) {
        // Validate required parameter: notebookId
        if (notebookId === undefined || notebookId === null) {
            throw new ValidationError('notebookId is required', 'notebookId');
        }
