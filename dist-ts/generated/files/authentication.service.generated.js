...
export class AuthenticationServiceBase {
     ...
     */
    async checkAuth(path, _templateVars, requestOptions) {
        ...
        return this.http.checkauth(requestUrl, requestData);
    }
    /**
     ...
     */
    async logout(path, _templateVars, requestOptions) {
        // Validate required parameter: path
        if (path === undefined || path === null) {
            throw new ValidationError('path is required', 'path');
        }
        ...
        return this.http.logout(requestUrl, requestData);
    }
}
