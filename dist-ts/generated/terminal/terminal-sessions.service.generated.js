...
export class TerminalSessionsServiceBase {
     ...
     */
    async listHistory(terminal_id, _templateVars, requestOptions) {
     ...
     */
    async *listHistoryIterator(...args) {
        ...
        while (hasNext && pageCount < maxPages) {
            ...
            const response = await this.listHistory(...requestArgs);
     ...
     */
    async delete(terminal_id, _templateVars, requestOptions) {
        // Validate required parameter: terminal_id
        if (terminal_id === undefined || terminal_id === null) {
            throw new ValidationError('terminal_id is required', 'terminal_id');
        }
     ...
     */
    async getRawOutput(options, _templateVars) {
     ...
     */
    async captureScreenshot(options, _templateVars) {
