...
export class MagicCommentsServiceBase {
     ...
     */
    async getSchema(_templateVars, requestOptions) {
     ...
     */
    async updateHandler(data, _templateVars, requestOptions) {
     ...
     */
    async bulkUpdate(data, _templateVars, requestOptions) {
        // Build URL with template variables (from constructor's defaultUrlTemplateVariables or method-level _templateVars)
