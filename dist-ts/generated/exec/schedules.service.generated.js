...
export class SchedulesServiceBase {
     ...
     */
    async listSchedules(_templateVars, requestOptions) {
     ...
     */
    async triggerSchedule(data, _templateVars, requestOptions) {
     ...
     */
    async reloadSchedules(data, _templateVars, requestOptions) {
        // Build URL with template variables (from constructor's defaultUrlTemplateVariables or method-level _templateVars)
     ...
     */
    async scheduleHistory(options, _templateVars) {
