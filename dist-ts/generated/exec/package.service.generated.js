...
export class PackageServiceBase {
     ...
     */
    async readJson(_templateVars, requestOptions) {
     ...
     */
    async updateJson(data, _templateVars, requestOptions) {
        // Build URL with template variables (from constructor's defaultUrlTemplateVariables or method-level _templateVars)
     ...
     */
    async compare(data, _templateVars, requestOptions) {
     ...
     */
    async pinVersions(data, _templateVars, requestOptions) {
        // Build URL with template variables (from constructor's defaultUrlTemplateVariables or method-level _templateVars)
     ...
     */
    async initJson(data, _templateVars, requestOptions) {
        // Build URL with template variables (from constructor's defaultUrlTemplateVariables or method-level _templateVars)
