...
export class SharedStateServiceBase {
     ...
     */
    async get(data, _templateVars, requestOptions) {
     ...
     */
    async set(data, _templateVars, requestOptions) {
        // Validate required parameter: data
        if (data === undefined || data === null) {
            throw new ValidationError('data is required', 'data');
        }
     ...
     */
    async clear(data, _templateVars, requestOptions) {
        // Validate required parameter: data
        if (data === undefined || data === null) {
            throw new ValidationError('data is required', 'data');
        }
