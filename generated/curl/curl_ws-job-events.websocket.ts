...
export class CurlWsJobEventsWebSocket implements ICurlWsJobEventsWebSocket {
   ...
   */
  onJobstarted(callback: (message: JobstartedServerMessage) => void): () => void {
    return this.addEventListener("jobstarted", callback);
  }
   ...
   */
  onJobprogress(callback: (message: JobprogressServerMessage) => void): () => void {
    return this.addEventListener("jobprogress", callback);
  }
   ...
   */
  onJobcompleted(callback: (message: JobcompletedServerMessage) => void): () => void {
    return this.addEventListener("jobcompleted", callback);
  }
