...
export interface ApiEventsGetResponse {
  statusCode: 200;
  message: string;
  data: { id: string; event_type: "container.creating" | "container.running" | "container.stopped" | "container.failed" | "container.deleting" | "container.deleted" | "container.autostart_enabled" | "container.autostart_disabled" | "container.renamed" | "container.resource_updated" | "container.ssh_key.added" | "container.ssh_key.removed" | "container.snapshot.created" | "container.snapshot.deleted" | "container.snapshot.restored" | "container.snapshot.renamed" | "container.display.enabled" | "storage.share.created" | "storage.share.updated" | "storage.share.deleted" | "storage.share.enabled" | "storage.share.disabled" | "storage.share.expiring_soon" | "storage.share.expired" | "storage.share.mount_changed" | "notification.created" | "notification.read" | "notification.deleted" | "project.created" | "project.updated" | "project.deleted" | "server.created" | "server.updated" | "server.enabled" | "server.disabled" | "server.health_changed" | "server.rental_expiring" | "firewall.rule.added" | "firewall.rule.removed" | "firewall.rule.updated" | "firewall.rule.enabled" | "firewall.rule.disabled" | "proxy.alias.created" | "proxy.alias.updated" | "proxy.alias.deleted" | "proxy.alias.enabled" | "proxy.alias.disabled" | "proxy.alias.expiring_soon" | "proxy.alias.expired" | "proxy.permissions.updated" | "proxy.permissions.default_changed" | "proxy.permissions.group_added" | "proxy.permissions.group_updated" | "proxy.permissions.group_removed" | "auth.token.created" | "auth.token.updated" | "auth.token.deleted" | "auth.token.enabled" | "auth.token.disabled" | "pool.member.joined" | "pool.member.left" | "pool.member.role_changed" | "pool.invited" | "pool.invitation_revoked" | "user.created" | "user.banned" | "user.unbanned" | "user.role_changed" | "activity.logged"; resource_type: "container" | "storage_share" | "notification" | "project" | "server" | "firewall" | "proxy_alias" | "proxy_permissions" | "auth_token" | "pool" | "user" | "activity_log"; resource_id: string; user_id: string; payload: Record<string, unknown>; realm_ids: string[]; created_at: string };
}
...
export interface ListServerOffersResponse {
  statusCode: number;
  message: string;
  data: ({ id: string; name?: string; country?: string; region?: null | string; city?: null | string; datacenter?: null | string; cpu_model?: null | string; cpu_cores?: null | number; cpu_threads?: null | number; ram_gb?: null | number; disks?: null | Record<string, unknown>[]; bandwidth_mbps?: null | number; traffic_tb?: null | number; traffic_unlimited?: boolean; ipv4_count?: number; pricing_rules?: Record<string, unknown> | null; hold_rules?: Record<string, unknown> | null; setup_fee_cents?: number; setup_fee_rules?: Record<string, unknown> | null; delivery_hours?: number; setup_time_minutes?: number; stock?: null | number })[];
}
