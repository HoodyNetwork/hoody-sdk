...
import type {
  ...
  AgentSetACPEnabledRequest,
  AgentSetACPEnabledResponse,
  AgentSetACPAgentModelRequest,
  AgentSetACPAgentModelResponse,
...
export abstract class SettingsServiceBase {
   ...
   */
  async setACPEnabled(agent: string, data?: AgentSetACPEnabledRequest, options?: { realm?: string; XHoodyCwd?: string; XHoodyConfigDir?: string; XHoodyContainer?: string; XHoodyRealm?: string; signal?: AbortSignal; timeoutMs?: number; retries?: number; retryDelayMs?: number; retryOnStatuses?: number[]; middlewareContext?: Record<string, unknown>; authRetry?: boolean; rawResponse?: boolean; responseType?: 'auto' | 'json' | 'text' | 'arrayBuffer' | 'blob'; }, _templateVars?: { projectId?: string; containerId?: string; serviceIndex?: string | number; server?: string }): Promise<AgentSetACPEnabledResponse> {
   const { realm, XHoodyCwd, XHoodyConfigDir, XHoodyContainer, XHoodyRealm, signal, timeoutMs, retries, retryDelayMs, retryOnStatuses, middlewareContext, authRetry, rawResponse, responseType } = options || {};
   ...
   if (XHoodyRealm !== undefined && XHoodyRealm !== null) {
    ...
    return this.http.put<AgentSetACPEnabledResponse>(requestUrl, requestData);
   ...
   */
  async setACPAgentModel(agent: string, data?: AgentSetACPAgentModelRequest, options?: { realm?: string; XHoodyCwd?: string; XHoodyConfigDir?: string; XHoodyContainer?: string; XHoodyRealm?: string; signal?: AbortSignal; timeoutMs?: number; retries?: number; retryDelayMs?: number; retryOnStatuses?: number[]; middlewareContext?: Record<string, unknown>; authRetry?: boolean; rawResponse?: boolean; responseType?: 'auto' | 'json' | 'text' | 'arrayBuffer' | 'blob'; }, _templateVars?: { projectId?: string; containerId?: string; serviceIndex?: string | number; server?: string }): Promise<AgentSetACPAgentModelResponse> {
   const { realm, XHoodyCwd, XHoodyConfigDir, XHoodyContainer, XHoodyRealm, signal, timeoutMs, retries, retryDelayMs, retryOnStatuses, middlewareContext, authRetry, rawResponse, responseType } = options || {};
   // Validate required parameter: agent
   if (agent === undefined || agent === null) {
     throw new ValidationError('agent is required', 'agent');
   ...
   if (XHoodyRealm !== undefined && XHoodyRealm !== null) {
    ...
    return this.http.put<AgentSetACPAgentModelResponse>(requestUrl, requestData);
