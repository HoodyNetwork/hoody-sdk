# Index of `/SKILLS/SKILL-CLI/`

One file per namespace for the CLI surface. Fetch only the namespaces a task needs.

- [`../`](../) — parent directory

## Namespaces

- [`agent.md`](agent.md) — CLI skill · `agent` namespace · ~20,419 tokens
- [`api.md`](api.md) — CLI skill · `api` namespace · ~14,350 tokens
- [`browser.md`](browser.md) — CLI skill · `browser` namespace · ~5,762 tokens
- [`code.md`](code.md) — CLI skill · `code` namespace · ~5,487 tokens
- [`cron.md`](cron.md) — CLI skill · `cron` namespace · ~3,574 tokens
- [`curl.md`](curl.md) — CLI skill · `curl` namespace · ~5,770 tokens
- [`daemon.md`](daemon.md) — CLI skill · `daemon` namespace · ~6,417 tokens
...
- [`notifications.md`](notifications.md) — CLI skill · `notifications` namespace · ~4,994 tokens
