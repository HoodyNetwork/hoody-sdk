# Index of `/SKILLS/SKILL-SDK/`

One file per namespace for the SDK surface. Fetch only the namespaces a task needs.
...
- [`curl.md`](curl.md) — SDK skill · `curl` namespace · ~9,068 tokens
- [`daemon.md`](daemon.md) — SDK skill · `daemon` namespace · ~9,489 tokens
- [`display.md`](display.md) — SDK skill · `display` namespace · ~12,999 tokens
- [`exec.md`](exec.md) — SDK skill · `exec` namespace · ~13,339 tokens
- [`files.md`](files.md) — SDK skill · `files` namespace · ~30,097 tokens
- [`notes.md`](notes.md) — SDK skill · `notes` namespace · ~15,697 tokens
- [`notifications.md`](notifications.md) — SDK skill · `notifications` namespace · ~6,182 tokens
- [`pipe.md`](pipe.md) — SDK skill · `pipe` namespace · ~5,294 tokens
