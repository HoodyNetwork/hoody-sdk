...
```html
<script src="https://cdn.jsdelivr.net/npm/hoody-sdk@1.0.0-beta.6/dist/hoody-sdk.browser.min.js"></script>
```
...
```html
<script type="module">
  import { HoodyClient } from 'https://cdn.jsdelivr.net/npm/hoody-sdk@1.0.0-beta.6/dist/hoody-sdk.browser.esm.js';
</script>
```
