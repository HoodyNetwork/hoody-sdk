# Index of `/SKILLS/SKILL-HTTP/`

One file per namespace for the HTTP surface. Fetch only the namespaces a task needs.
...
- [`curl.md`](curl.md) — HTTP skill · `curl` namespace · ~6,585 tokens
- [`daemon.md`](daemon.md) — HTTP skill · `daemon` namespace · ~7,341 tokens
- [`display.md`](display.md) — HTTP skill · `display` namespace · ~7,701 tokens
- [`exec.md`](exec.md) — HTTP skill · `exec` namespace · ~9,654 tokens
- [`files.md`](files.md) — HTTP skill · `files` namespace · ~30,756 tokens
- [`notes.md`](notes.md) — HTTP skill · `notes` namespace · ~11,039 tokens
- [`notifications.md`](notifications.md) — HTTP skill · `notifications` namespace · ~5,514 tokens
- [`pipe.md`](pipe.md) — HTTP skill · `pipe` namespace · ~4,906 tokens
