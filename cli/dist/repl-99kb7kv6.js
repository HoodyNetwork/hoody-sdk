import{b as Yz,c as Zz,d as $z,e as _z,f as Oz,g as M,h as p,i as f}from"./index-pstw60ny.js";import"./index-kehn617h.js";import{A as Hz,r as E,s as Xz,t as l,u as g,v as u,w as k,x as c,y as Nz,z as Bz}from"./index-0124zh50.js";import{B as Jz}from"./index-ez9f88t0.js";import{Ma as zz,Na as Gz}from"./index-tm9rkke9.js";import"./index-q3adgcxs.js";import K from"chalk";import pz from"node:readline";import{open as fz}from"node:fs/promises";import{existsSync as gz}from"node:fs";import{join as kz}from"node:path";import T from"chalk";function Kz(){return kz(zz(),".hoody","chats",".seen-privacy-banner")}function mz(){return gz(Kz())}async function hz(){await Jz();try{await(await fz(Kz(),"wx",384)).close()}catch(V){if(V?.code!=="EEXIST")process.stderr.write(`[hoody chat] Could not write banner marker: ${V?.message??V}
