import{r as G,u as N,v as Q,w as U,x as V,z as W}from"./index-fwf9j01m.js";import"./index-7fhef6ck.js";import"./index-adz920n5.js";import"./index-wy0t6427.js";import L from"chalk";var _=(q)=>process.stdout.isTTY?L.green(q):q,B=(q)=>process.stdout.isTTY?L.dim(q):q;var H=(q)=>process.stdout.isTTY?L.red(q):q;async function v(){let q=await Q();if(q.length===0){process.stdout.write(B(`No persistent chat sessions found.
