import{r as G,u as N,v as Q,w as U,x as V,z as W}from"./index-0124zh50.js";import"./index-ez9f88t0.js";import"./index-tm9rkke9.js";import"./index-q3adgcxs.js";import L from"chalk";var _=(q)=>process.stdout.isTTY?L.green(q):q,B=(q)=>process.stdout.isTTY?L.dim(q):q;var H=(q)=>process.stdout.isTTY?L.red(q):q;async function v(){let q=await Q();if(q.length===0){process.stdout.write(B(`No persistent chat sessions found.
